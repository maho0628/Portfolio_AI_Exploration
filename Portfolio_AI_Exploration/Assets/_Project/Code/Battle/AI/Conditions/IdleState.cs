...
/// 待機状態を表すステート。
/// 次に実行可能なスキルを優先的に判定し、
/// 条件を満たさない場合はSkillPreparationStateへ遷移する。
/// </summary>
public class IdleState : BattleState
{
    ...
    /// 実行できない場合はSkillPreparationStateへ遷移する。
    internal override void Tick()
    {
        ...
        bool skillStarted = owner.TryDecideNextAction();
        ...
        owner.SwitchState(owner.SkillPreparationState);
